...
namespace AspnetRunBasics.Services
{
    public class CatalogService : ICatalogService
    {
        ...
        {
            logger.LogInformation("Getting Catalog Products from url: {url} and customer property: {customerProperty}", _client.BaseAddress, 6);
            ...
            {
                logger.LogError(exception, "An error occurs when retrieving Catalog.");
            }
